...
Proof with auto.
  ...
  dependent induction H...
  - split;intros.
    + constructor. apply M.WFS_type in H1...
    + constructor. apply M.WFS_type in H1...
  - split;intros.
    + destruct (X == X0).
...
Proof with auto.
  ...
  - apply is_Menv_str_mu_distrb in H3...
    destruct H3 as [L0].
    apply M.WFM_rec with (L:=L \u L0 \u fv_tt A)... intros.
...
Lemma Msub_complete_aux_relax: forall E A B,
  ...
  forall E' im,
  is_Menv_str im A B E' E ->
  (M.Sub im M.Lt E' A B) \/ (M.Sub im M.Eq E' A B).
Proof with auto.
  intros E A B Hsub.
  induction Hsub;intros...
  - left. apply M.Sa_nat... admit.
  - destruct (decide_typ A typ_top).
    + subst. left. constructor... admit.
    + left. apply M.Sa_top_lt... admit. admit.
  - pose proof is_Menv_sem _ _ _ _ _ X H1 H.
    destruct H2;destruct_hypos.
    + left. apply M.Sa_fvar_pos... admit.
